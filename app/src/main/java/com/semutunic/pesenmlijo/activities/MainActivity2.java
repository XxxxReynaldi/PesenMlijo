...
public class MainActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bottomNavigation = findViewById(R.id.menu_bawah2);
        ...
        bottomNavigation.add(new MeowBottomNavigation.Model(3, R.drawable.akun));
        ...
        bottomNavigation.setOnShowListener(new MeowBottomNavigation.ShowListener() {
            ...
            public void onShowItem(MeowBottomNavigation.Model item) {
                ...
                switch (item.getId()) {
                    case 1:
                        selectedFragment = new BerandaPembeliFragment();
                        break;
                    case 2:
                        selectedFragment = new PesananPembeliFragment();
                        break;
                    case 3:
